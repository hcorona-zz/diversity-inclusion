...
- ð Provide large-text signs and easy-to-read maps. Include maps in advance, with the event schedule.
...
- To be more inclusive to those with hearing impairments and those with English as a second language, closed captioning ban be provided either in real time, or once the talk videos are put online. 
...
- ð Provide tampons and pads in **all** restrooms (some people who identify as male have periods and may need them)


## ð Nursing &amp; Pumping Room
...
## ð Gender-Neutral Bottle Feeding Room
  ...
  - This should be a separate, additional room ( **NOT the same as the nursing and pumping room** ). **Further Reading:**

## ð Quiet Room

Ensure that a room is also made available where anyone who needs a quiet space away from the main conference can retreat. Label the room accordingly.
